...
class TestCreator(unittest.TestCase):
    ...
    @patch("builtins.open")
    def test_generate_problem(self, mock_open, mock_get_data, mock_get_slug):
    ...
    @patch("leetcode_study_tool.creator.get_slug")
    def test_generate_problem_with_code(
        self, mock_get_slug, mock_get_neetcode_solution, mock_get_data
    ):
        mock_get_slug.return_value = "two-sum"
        mock_get_data.return_value = {
            "id": "1",
        ...
        mock_get_neetcode_solution.return_value = (
        ...
        with patch.dict(
            ...
            mock_problem_creator = creator.ProblemsCreator(
                self.fake_parsed_args_with_code
            )
            mock_problem_creator._generate_problem("two-sum")
